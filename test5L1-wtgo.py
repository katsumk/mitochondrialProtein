...
fname = (odir + "/lr1.coef-%s.png" % os.path.basename(sys.argv[0] ))
...
plt.xlim([-1, max_feat])
plt.tight_layout()
fname = (odir + "/lr1.coef-%s-%s.png" % (max_feat, os.path.basename(sys.argv[0]) ))
...
df.to_csv(odir+"/lr1-coef-%s.csv" % os.path.basename(sys.argv[0]) , sep=",")
